// Research prompts run in parallel per company on the Sourced → Researched
// transition. Results cached 14d in ResearchCache. The OpenAI Responses API
// with web_search returns text + url_citation annotations; we keep the answer
// text-shaped and extract structured signals at the engine level.
//
// Content rewrites for Quanta-fit framing land in the AI-prompts task.
